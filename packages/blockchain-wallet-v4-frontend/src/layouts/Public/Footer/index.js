...
const Footer = () => {
  return (
    <Wrapper>
      <LinkContainer>
        <Image name='blue-logo' height='80px' width='80px' />
        <Link
          href='https://wampum1st.com/balance'
          size='12px'
          weight={300}
          color='white'
          uppercase
        ...
        <Link
          href='https://wampum1st.com/#about'
          size='12px'
          weight={300}
          color='white'
          uppercase
        ...
        <Link
          href='https://wampum1st.com/support'
          size='12px'
          weight={300}
          color='white'
          uppercase
