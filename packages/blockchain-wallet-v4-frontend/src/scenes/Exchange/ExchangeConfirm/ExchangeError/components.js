      ...
      return (
        <React.Fragment>
          ...
          <Button nature='empty-secondary' height='56px' size='17px'>
            <Link
              href='https://support.wmpm.io/hc/en-us/articles/360023587292-Order-failed-due-to-market-movements'
    ...
    case WEEKLY_LIMIT_EXCEEDED: {
      return (
        <React.Fragment>
          ...
          <Button nature='empty-secondary' height='56px' size='17px'>
            <Link
              href='https://support.wmpm.io/hc/en-us/articles/360018353031-Exchange-Limit-Amounts'
              rel='noopener noreferrer'
              target='_blank'
            >
              <FormattedMessage
