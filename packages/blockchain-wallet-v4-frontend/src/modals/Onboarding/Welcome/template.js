        ...
        <Container>
          <Text size='26px' weight={300}>
            <FormattedMessage
              ...
              defaultMessage='Welcome to Wampum1st!'
            />
          </Text>
          <Text size='16px' weight={300}>
            <FormattedMessage
              id='modals.welcome.thanks'
              defaultMessage='Thanks for joining over {walletMillions} million Wampum1st wallet users in helping create an open, accessible, and fair financial future. Your wallet makes transacting with digital currencies simple and secure. Get started now.'
