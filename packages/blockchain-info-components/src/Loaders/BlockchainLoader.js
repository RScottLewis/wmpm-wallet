...
`
const SquareMarketingSecondary = styled(Circle)`
  background-color: ${props => props.theme['marketing-secondary']};
`
const SquareTransferred = styled(Circle)`
  background-color: ${props => props.theme['transferred']};
`
const SquareMarketingPrimary = styled(Circle)`
  background-color: ${props => props.theme['marketing-primary']};
`
const SquareBrandTertiary = styled(Circle)`
  background-color: ${props => props.theme['brand-tertiary']};
`
const SquareBrandSecondary = styled(Circle)`
